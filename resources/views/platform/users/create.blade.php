        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form data-toggle="validator" enctype="multipart/form-data" class="form" method="POST" action="{{ route('users.store') }}">
                        @csrf
                            ...
                            <div class="col-10">
                                <select class="form-control" name="tenant_id" id="tenant-select">
                                    ...
                                    @foreach($tenants as $tenant)
                                        <option value="{{ $tenant->id }}">{{ $tenant->name }} ({{ $tenant->subdomain }})</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="text" name="name" placeholder="Full Name" required id="example-name-input">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="email" name="email" placeholder="Email Address" required id="example-email-input">
                                <small class="form-text text-muted">An email will be sent to verify this address</small>
                            </div>
                        </div>
