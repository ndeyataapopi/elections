        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-subtitle">Update Election Information</h5>
                    ...
                    <form id="elections-form" data-toggle="validator" enctype="multipart/form-data" class="form" method="POST" action="{{ route('elections.update', $election->id) }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control input" type="text" name="election_name" value="{{ $election->name }}" placeholder="Election Name" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-search-input" class="col-2 col-form-label">Start Date & Time</label>
                            <div class="col-10">
                                <input class="form-control input" type="datetime-local" name="start_time" value="{{ $election->start_time }}" placeholder="Select Start Date & Time" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control input" type="datetime-local" name="end_time" value="{{ $election->end_time }}" placeholder="Select End Date & Time" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control input" type="number" name="allowed_votes" value="{{ $election->allowed_votes }}" placeholder="Enter Allowed Number of Votes Per Voter" required>
                            </div>
                        </div>
                            ...
                            <div class="col-10">
                                <select class="select2 form-control" multiple="multiple" name="approval_admins[]" style="height: 36px;width: 100%;" required>
                                    @foreach($clientAdmins as $admin)
                                        <option value="{{ $admin->id }}" {{ in_array($admin->id, $selectedApprovalAdmins) ? 'selected' : '' }}>
                        ...
                        <div class="form-group col-10 mt-5 row">
                            <button type="submit" class="btn btn-success mr-2">Update Election</button>
